...
const TabLocation: React.FC<{ tour: Tour }> = ({ tour }) => {
  return (
    <div>
      ...
      <li className="pt-4">
        <span>{tour.location}</span> This destination offers a variety of transport options, including public transit, car rentals, and guided tours for convenient travel. You can explore a range of accommodations, from luxury hotels to cozy boutique stays, ensuring a comfortable visit. Additionally, the area is home to popular attractions, local eateries, and cultural landmarks, making it a perfect spot for both adventure and relaxation.
      </li>
    </div>
  );
};
