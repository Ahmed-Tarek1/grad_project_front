        ...
        <div className="relative">
          ...
          <div className="flex items-center mt-[-75px] px-10 pb-8 z-10 relative">
            ...
            <div className="ml-5 flex-1">
              <div className="flex items-center">
                <h1 className="text-3xl font-bold text-orange-500 mt-20">
                  {company.name}
                </h1>
        ...
        <div className="flex gap-5 mt-5">
          ...
          <div className="w-[750px]">
            <div className="flex justify-between border-b-2 border-gray-200 mb-5">
              <button
                className={`pb-2 px-4 text-gray-600 font-semibold ${
                  activeTab === "Posts" ? "border-b-2 border-[#DF6951]" : ""
                }`}
              ...
              <button
                className={`pb-2 px-4 text-gray-600 font-semibold ${
                  activeTab === "Trips" ? "border-b-2 border-[#DF6951]" : ""
                }`}
              ...
              <button
                className={`pb-2 px-4 text-gray-600 font-semibold ${
                  activeTab === "Photos" ? "border-b-2 border-[#DF6951]" : ""
                }`}
              ...
              <button
                className={`pb-2 px-4 text-gray-600 font-semibold ${
                  activeTab === "Review" ? "border-b-2 border-[#DF6951]" : ""
                }`}
                onClick={() => setActiveTab("Review")}
              >
                Review
...
// Assuming there are 25 companies and 10 companies per page, there would be 3 pagination items.
// This is just an assumption and should be adjusted based on the actual number of companies and the desired pagination size.
