...
export interface Tour {
  ...
  included: string[];  // تأكد من وجود هذه الخاصية
  notIncluded: string[]; // وتأكد من وجود هذه الخاصية
  categoryId?: number;
}
...
//         time: "3 hours ago",
//         text: "Experience luxury in the sky with our new First Class suites! ✈️",
