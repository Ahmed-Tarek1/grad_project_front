...
const isOpenNow = (): boolean => {
  ...
  const todayHours = workingHoursFormatted.find(item => 
  ...
  try {
    ...
    // تحويل الأوقات إلى دقائق منذ منتصف الليل لتسهيل المقارنة
    ...
    // معالجة الحالة عندما يكون وقت الإغلاق بعد منتصف الليل (مثل 22:00 - 02:00)
  ...
  return (
    <div className="relative font-sans max-w-[1400px] mx-auto p-5 mb-40">
