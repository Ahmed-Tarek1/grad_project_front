...
import { Star, ChevronLeft, ChevronRight, X, MapPin, Clock, Users, CalendarDays, Utensils, Wifi, Bus } from 'lucide-react';
...
const discounts = [
  {
    ...
    discount: 50,
    isLimitedTime: true,
    description: "Experience luxury and relaxation at Hurghada Beach Resort. This all-inclusive package includes beachfront accommodation, water sports activities, and gourmet dining options.",
    highlights: [
    ...
    amenities: ["Free Breakfast", "Free Internet", "Pool", "Spa", "Beach Access"],
    itinerary: [
      {
        day: 1,
        activities: ["Airport pickup", "Welcome dinner", "Resort orientation"]
      },
      {
        day: 2,
        activities: ["Breakfast", "Snorkeling trip", "Beach BBQ dinner"]
      },
      {
        day: 3,
        activities: ["Desert safari", "Sunset dinner"]
      }
    ]
  },
  {
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="flex items-center gap-2 mb-4">
                <span className="line-through text-gray-500">{trip.originalPrice} EG</span>
                <span className="text-green-600">
                  Save {trip.originalPrice - trip.price} ({Math.round((trip.originalPrice - trip.price) / trip.originalPrice * 100)}%)
                </span>
              </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              {trip.amenities.map((amenity: string, index: number) => (
                <div key={index} className="flex items-center gap-2">
                  {amenity.includes('Breakfast') && <Utensils size={20} className="text-gray-500" />}
...
const Travels = () => {
  ...
  const filteredTravels = travels.filter(trip => {
    ...
    // Rating filter
    if (selectedRating && trip.rating < selectedRating) {
      return false;
    }
    ...
    if (selectedCategories.length > 0) {
      // This is a simplified example. In a real application, each trip would have
      // a categories array that we would check against the selected categories
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        <h2 className="text-xl font-bold text-gray-900 mb-4">Special Discounts</h2>
        <div className="relative">
                ...
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="md:w-2/3">
                    ...
                    <div className="mb-4">
                      ...
                      <span className="ml-2 text-gray-600">{trip.originalPrice}EG</span>
