      ...
      <section className="py-16 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900">No recommended events found</h3>
        ...
        <div className="relative">
          ...
          >
            <div className="relative h-[400px] lg:h-[500px] rounded-xl overflow-hidden">
              <img
                src={currentEvent.image || 'https://images.unsplash.com/photo-1505373877841-8d25f7d46678?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80'}
              ...
              <div className="flex space-x-4">
                ...
                {currentEvent.map_Link && (
                  <button 
                    ...
                    onClick={() => window.open(currentEvent.map_Link!, '_blank')}
                  >
                    View on Map
                  </button>
                )}
